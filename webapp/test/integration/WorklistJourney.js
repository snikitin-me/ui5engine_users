sap.ui.define(['sap/ui/test/opaQunit'], function(opaTest) {
  ...
  opaTest(
    'Should see the busy indicator on app view while worklist view metadata is loaded',
    function(Given, When, Then) {
      // Arrangements
      Given.iStartMyApp({
        delay: 5000
  ...
  opaTest(
    'Should see the busy indicator on worklist table after metadata is loaded',
    function(Given, When, Then) {
      //Actions
      ...
      // Assertions
      Then.onTheWorklistPage
        .iShouldSeeTheWorklistTableBusyIndicator()
