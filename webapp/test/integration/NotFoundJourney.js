sap.ui.define(['sap/ui/test/opaQunit'], function(opaTest) {
  ...
  opaTest(
    'Should see the resource not found page when changing to an invalid hash',
  ...
  opaTest(
    "Clicking the 'Show my worklist' link on the 'Resource not found' page should bring me back to the worklist",
    function(Given, When, Then) {
      //Actions
  ...
  opaTest('Should see the not found text for no search results', function(
    Given,
    When,
    Then
  ) {
  ...
  opaTest(
    'Clicking the back button should take me back to the not found page',
    function(Given, When, Then) {
      //Actions
      When.onTheBrowser.iPressOnTheBackwardsButton()

      // Assertions
      Then.onTheNotFoundPage
  ...
  opaTest(
    "Should see the 'Object not found' page if an invalid object id has been called",
    function(Given, When, Then) {
      Given.iStartMyApp({
  ...
  opaTest(
    "Clicking the 'Show my worklist' link on the 'Object not found' page should bring me back to the worklist",
    function(Given, When, Then) {
      //Actions
      When.onTheAppPage.iWaitUntilTheAppBusyIndicatorIsGone()
