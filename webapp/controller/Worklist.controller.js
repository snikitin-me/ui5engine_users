sap.ui.define(
  ...
  function(BaseController, JSONModel, formatter, Filter, FilterOperator) {
    ...
    return BaseController.extend('engine.users.controller.Worklist', {
      formatter: formatter,
      ...
      onInit: function() {
        ...
        this.getRouter()
          .getRoute('worklist')
          .attachPatternMatched(this._loadUserSet, this)
      ...
      _loadUserSet: function() {
        var objectEntitySetName = this.getOwnerComponent().getObjectEntitySetName()

        $.getJSON(
          objectEntitySetName,
          function(response) {
            //   this.getModel("worklistView").setProperty("/UserSet", response.d.results);
            this.getOwnerComponent()
              .getModel()
              .setProperty('/UserSet', response.d.results)
            this.getModel().setProperty('/UserSet', response.d.results)
          }.bind(this)
        )
      },
